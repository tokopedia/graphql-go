...
func (s *Schema) Validate(queryString string) (bool, []*errors.QueryError) {
...
func (s *Schema) ValidateWithVariables(queryString string, variables map[string]interface{}) (bool, []*errors.QueryError) {
